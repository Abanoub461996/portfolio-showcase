...
const ProjectCard = ({ project }: { project: ProjectProps }) => {
  return (
    <Card className={`overflow-hidden card-hover ${project.featured ? 'border-primary/30' : ''}`}>
      ...
      <CardFooter className="px-6 pb-6 pt-0 flex justify-between">
        {project.featured && (
          <Badge className="bg-primary/20 text-primary border-primary/30">Featured Project</Badge>
        )}
...
const Projects = () => {
  const projects = [
    {
      ...
      description: "Engaging, interactive 3D experiences on the web using Three.js, demonstrating skills in 3D modeling, animation, lighting, and user interaction design.",
    ...
    },
    {
      ...
      description: "A chess game simulation using Angular 16 deployed on Firebase with the ngx-chess-board library. The main page hosts two iframes, each loading a chess board with mirrored moves.",
  ...
  return (
    <section id="projects" className="section bg-gradient-to-b from-card to-background">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            These represent my passion for frontend development and 3D visualization.
          </p>
        </div>
        ...
        <div className="mt-16 max-w-3xl mx-auto glass p-8 text-center">
          ...
          <h3 className="text-xl font-bold mb-3">Interested in my 3D visualization work?</h3>
