...
const Hero = () => {
  ...
  const phrases = ["React Developer", "Angular Developer", "Next.js Developer", "3D Enthusiast"];
  ...
  useEffect(() => {
    ...
    const typingInterval = setInterval(() => {
      if (charIndex <= phrase.length) {  // Changed < to <= to include all characters
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 animate-slide-up">
            I build exceptional, interactive user experiences with modern frontend technologies.
            Specializing in React, Angular, and 3D visualizations.
          </p>
